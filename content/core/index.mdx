---
title: Overview
description: Get a high-level understanding of Waterbus, including its architecture, use cases, and how it enables real-time audio/video streaming across platforms.
---
...
<Cards>
  ...
  >
    ...
    title="Server SDK"
  >
    Build backend integrations with full control using the Waterbus Server SDK.
  </Card>
</Cards>
...
- 🧑‍💻 [Quickstart Guide](/en/core/local)
- 📱 [Using the Flutter SDK](/en/flutter-sdk)
